...
var _user$project$NavBar$view = A2(
	_elm_lang$html$Html$nav,
	_elm_lang$core$Native_List.fromArray(
		[
			_elm_lang$html$Html_Attributes$class('navbar navbar-fixed-top navbar-default navbar-static-top'),
		...
		[
			...
			_elm_lang$core$Native_List.fromArray(
				[
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html$text('Master Software Engineering - stil4m')
						]))
				]))
		]));

var _user$project$Menu_Base$Item = F2(
	function (a, b) {
		return {name: a, key: b};
	});
var _user$project$Menu_Base$Leaf = function (a) {
	return {ctor: 'Leaf', _0: a};
};
var _user$project$Menu_Base$Node = F3(
	function (a, b, c) {
		return {ctor: 'Node', _0: a, _1: b, _2: c};
	});

var _user$project$Menu_SoftwareTesting$testingWeek = _elm_lang$core$Native_List.fromArray(
	[
		_user$project$Menu_Base$Leaf(
...
var _user$project$Menu_SoftwareTesting$menu = A3(
	_user$project$Menu_Base$Node,
	{name: 'Software Testing', key: 'software-testing'},
	false,
	_elm_lang$core$Native_List.fromArray(
		[
			A3(
			_user$project$Menu_Base$Node,
			{name: 'Week 1: 2015-08-31', key: 'w1'},
			false,
			_user$project$Menu_SoftwareTesting$testingWeek),
			A3(
			_user$project$Menu_Base$Node,
			{name: 'Week 2: 2015-09-07', key: 'w2'},
			false,
			_user$project$Menu_SoftwareTesting$testingWeek),
			A3(
			_user$project$Menu_Base$Node,
			{name: 'Week 3: 2015-09-14', key: 'w3'},
			false,
			_user$project$Menu_SoftwareTesting$testingWeek),
			A3(
			_user$project$Menu_Base$Node,
			{name: 'Week 4: 2015-09-21', key: 'w4'},
			false,
			_user$project$Menu_SoftwareTesting$testingWeek),
			A3(
			_user$project$Menu_Base$Node,
			{name: 'Week 5: 2015-09-28', key: 'w5'},
			false,
			_user$project$Menu_SoftwareTesting$testingWeek),
			A3(
			_user$project$Menu_Base$Node,
			{name: 'Week 6: 2015-10-05', key: 'w6'},
			false,
			_user$project$Menu_SoftwareTesting$testingWeek),
			A3(
			_user$project$Menu_Base$Node,
			{name: 'Week 7: 2015-10-12', key: 'w7'},
			false,
			_elm_lang$core$Native_List.fromArray(
				[
					_user$project$Menu_Base$Leaf(
			...
			_user$project$Menu_Base$Leaf(
			{name: 'Test Preparation', key: 'test-preparation'}),
			_user$project$Menu_Base$Leaf(
			{name: 'Literature', key: 'literature'})
		]));

var _user$project$Menu_SoftwareEvolution$menu = A3(
	_user$project$Menu_Base$Node,
	{name: 'Software Evolution', key: 'software-evolution'},
	false,
	_elm_lang$core$Native_List.fromArray(
		[
			A3(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					_user$project$Menu_Base$Leaf(
					{name: 'Week 1: 2015-10-26', key: 'w1'}),
					_user$project$Menu_Base$Leaf(
					{name: 'Week 2: 2015-11-02', key: 'w2'}),
					_user$project$Menu_Base$Leaf(
					{name: 'Week 3: 2015-11-09', key: 'w3'}),
					_user$project$Menu_Base$Leaf(
					{name: 'Week 4: 2015-11-16', key: 'w4'}),
					_user$project$Menu_Base$Leaf(
					{name: 'Week 5: 2015-11-23', key: 'w5'}),
					_user$project$Menu_Base$Leaf(
					{name: 'Week 6: 2015-12-30', key: 'w6'}),
					_user$project$Menu_Base$Leaf(
					{name: 'Week 7: 2015-12-07', key: 'w7'}),
					_user$project$Menu_Base$Leaf(
					{name: 'Week 8: 2015-12-14', key: 'w8'})
				])),
			A3(
			_user$project$Menu_Base$Node,
			...
			_elm_lang$core$Native_List.fromArray(
				[
					_user$project$Menu_Base$Leaf(
					{name: 'Series 0', key: 'series0'}),
					_user$project$Menu_Base$Leaf(
					{name: 'Series 1', key: 'series1'})
				])),
			_user$project$Menu_Base$Leaf(
			{name: 'Resources', key: 'resources'}),
			_user$project$Menu_Base$Leaf(
...
var _user$project$Menu_SoftwareProcess$menu = A3(
	_user$project$Menu_Base$Node,
	{name: 'Software Process', key: 'software-process'},
	false,
	_elm_lang$core$Native_List.fromArray(
		[
			A3(
			_user$project$Menu_Base$Node,
			{name: 'Week 1: 2016-02-01', key: 'w1'},
			false,
			_elm_lang$core$Native_List.fromArray(
				[
					_user$project$Menu_Base$Leaf(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					_user$project$Menu_Base$Leaf(
					{name: 'Personal Reading', key: 'personal-reading/0-reading-list'})
				]))
		]));

var _user$project$Menu_RequirementsEngineering$menu = A3(
	_user$project$Menu_Base$Node,
	{name: 'Requirements Engineering', key: 'requirements-engineering'},
	false,
	_elm_lang$core$Native_List.fromArray(
		[
			_user$project$Menu_Base$Leaf(
			{name: 'Readings', key: 'readings'})
		]));

var _user$project$Menu_PaperSessions$menu = A3(
	_user$project$Menu_Base$Node,
	{name: 'Paper Sessions', key: 'paper-sessions'},
	false,
	_elm_lang$core$Native_List.fromArray(
		[
			_user$project$Menu_Base$Leaf(
			{name: 'Session 1 (2015-09-07)', key: 'session1'}),
			_user$project$Menu_Base$Leaf(
			{name: 'Session 2 (2015-11-02)', key: 'session2'}),
			_user$project$Menu_Base$Leaf(
			{name: 'Session 3 (2015-11-17)', key: 'session3'})
		]));

var _user$project$Menu$toggleItemIn = F2(
	function (item, list) {
		return A2(
			_elm_lang$core$List$map,
			_user$project$Menu$toggleItem(item),
			list);
	});
var _user$project$Menu$toggleItem = F2(
	function (source, target) {
		...
		if (_p0.ctor === 'Node') {
			...
			var _p2 = _p0._1;
			var _p1 = _p0._0;
			return _elm_lang$core$Native_Utils.eq(source, target) ? A3(
				_user$project$Menu_Base$Node,
				_p1,
				_elm_lang$core$Basics$not(_p2),
				_p3) : A3(
				_user$project$Menu_Base$Node,
				_p1,
				_p2,
				A2(_user$project$Menu$toggleItemIn, source, _p3));
		} else {
			return target;
		}
	});
var _user$project$Menu$update = F2(
	function (msg, model) {
		...
		if (_p4.ctor === 'Toggle') {
			return {
				ctor: '_Tuple2',
				_0: A2(_user$project$Menu$toggleItemIn, _p4._0, model),
...
var _user$project$Menu$initialModel = _elm_lang$core$Native_List.fromArray(
	[_user$project$Menu_SoftwareTesting$menu, _user$project$Menu_SoftwareEvolution$menu, _user$project$Menu_SoftwareProcess$menu, _user$project$Menu_RequirementsEngineering$menu, _user$project$Menu_PaperSessions$menu]);
var _user$project$Menu$Trigger = function (a) {
	return {ctor: 'Trigger', _0: a};
};
var _user$project$Menu$Toggle = function (a) {
	return {ctor: 'Toggle', _0: a};
};
var _user$project$Menu$renderLevelItem = F3(
	function (level, parents, item) {
		var _p5 = item;
		if (_p5.ctor === 'Leaf') {
			var _p6 = _p5._0;
			var p = A2(
			...
			var _p8 = _p5._0;
			var _p7 = _p5._1;
			var subItems = _p7 ? _elm_lang$core$Native_List.fromArray(
				[
					A3(
					_user$project$Menu$renderLevel,
					level + 1,
					A2(
						_elm_lang$core$Basics_ops['++'],
						parents,
				...
				[]);
			var caretClass = _p7 ? 'fa-angle-down' : 'fa-angle-right';
			return A2(
				_elm_lang$html$Html$li,
				_elm_lang$core$Native_List.fromArray(
					[]),
				A2(
					...
					A2(
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Events$onClick(
								_user$project$Menu$Toggle(item))
							]),
						_elm_lang$core$Native_List.fromArray(
							[
								A2(
									...
									[
										...
										_elm_lang$core$Native_List.fromArray(
											[
												...
												A2(_elm_lang$core$Basics_ops['++'], 'fa pull-right ', caretClass))
											]),
										_elm_lang$core$Native_List.fromArray(
											[]))
									]))
...
var _user$project$Menu$renderLevel = F3(
	function (level, parents, items) {
		return A2(
			...
			A2(
				_elm_lang$core$List$map,
				A2(_user$project$Menu$renderLevelItem, level, parents),
				items));
	});
...
var _user$project$PageLoader$view = function (model) {
...
var _user$project$PageLoader$initialModel = {page: '', loading: false, status: _elm_lang$core$Maybe$Nothing};
var _user$project$PageLoader$triggerMathjax = _elm_lang$core$Native_Platform.outgoingPort(
	'triggerMathjax',
	function (v) {
		return v;
	});
var _user$project$PageLoader$Model = F3(
	function (a, b, c) {
		return {loading: a, page: b, status: c};
	});
var _user$project$PageLoader$Loaded = function (a) {
	return {ctor: 'Loaded', _0: a};
};
var _user$project$PageLoader$Err = function (a) {
	return {ctor: 'Err', _0: a};
};
var _user$project$PageLoader$LoadPage = function (a) {
	return {ctor: 'LoadPage', _0: a};
};
var _user$project$PageLoader$StatusUpdate = function (a) {
	return {ctor: 'StatusUpdate', _0: a};
};
var _user$project$PageLoader$loadPage = function (p) {
	return A3(
		_elm_lang$core$Task$perform,
		function (_p2) {
			return _user$project$PageLoader$StatusUpdate(
				_user$project$PageLoader$Err(
...
var _user$project$PageLoader$update = F2(
	function (msg, model) {
		var _p4 = msg;
		if (_p4.ctor === 'StatusUpdate') {
			return A2(
				_elm_lang$core$Platform_Cmd_ops['!'],
				_elm_lang$core$Native_Utils.update(
					model,
					{
						status: _elm_lang$core$Maybe$Just(_p4._0)
					}),
				_elm_lang$core$Native_List.fromArray(
					[
						_user$project$PageLoader$triggerMathjax('X')
					]));
		} else {
			var _p5 = _p4._0;
			return A2(
				_elm_lang$core$Platform_Cmd_ops['!'],
				{page: _p5, loading: true, status: _elm_lang$core$Maybe$Nothing},
				_elm_lang$core$Native_List.fromArray(
					[
						_user$project$PageLoader$loadPage(_p5)
					]));
		}
	});

var _user$project$MasterSe$Model = F2(
	function (a, b) {
		return {menu: a, pageLoader: b};
	});
var _user$project$MasterSe$PageLoaderMsg = function (a) {
	return {ctor: 'PageLoaderMsg', _0: a};
};
var _user$project$MasterSe$initialModel = function (initialPage) {
	var pageLoader = _user$project$PageLoader$initialModel;
	return A2(
		_elm_lang$core$Platform_Cmd_ops['!'],
		{menu: _user$project$Menu$initialModel, pageLoader: pageLoader},
		function () {
			var _p0 = initialPage;
			if (_p0.ctor === 'Just') {
				return _elm_lang$core$Native_List.fromArray(
					[
						...
						_user$project$MasterSe$PageLoaderMsg,
						_user$project$PageLoader$loadPage(_p0._0))
					]);
			} else {
				return _elm_lang$core$Native_List.fromArray(
					[]);
...
var _user$project$MasterSe$update = F2(
	function (msg, model) {
		var _p1 = msg;
		if (_p1.ctor === 'MenuMsg') {
			var _p2 = A2(_user$project$Menu$update, _p1._0, model.menu);
			var newMenu = _p2._0;
			var page = _p2._1;
				...
				return A2(
					...
					_elm_lang$core$Native_List.fromArray(
						[
							...
							_elm_lang$core$Platform_Cmd$map,
							_user$project$MasterSe$PageLoaderMsg,
							_user$project$PageLoader$loadPage(_p3._0))
						]));
			}
		} else {
			var _p4 = A2(_user$project$PageLoader$update, _p1._0, model.pageLoader);
			var newPageLoader = _p4._0;
			var pageLoaderCmds = _p4._1;
			return A2(
				_elm_lang$core$Platform_Cmd_ops['!'],
				_elm_lang$core$Native_Utils.update(
					model,
					{pageLoader: newPageLoader}),
				_elm_lang$core$Native_List.fromArray(
					[
						A2(_elm_lang$core$Platform_Cmd$map, _user$project$MasterSe$PageLoaderMsg, pageLoaderCmds)
					]));
		}
	});
var _user$project$MasterSe$MenuMsg = function (a) {
	return {ctor: 'MenuMsg', _0: a};
};
var _user$project$MasterSe$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[
		...
		_elm_lang$core$Native_List.fromArray(
			[
				_user$project$NavBar$view,
				A2(
				_elm_lang$html$Html$div,
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$id('page-wrapper'),
						_elm_lang$html$Html_Attributes$style(
						_elm_lang$core$Native_List.fromArray(
							[
								{ctor: '_Tuple2', _0: 'margin-left', _1: '300px'}
							]))
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								...
								_user$project$MasterSe$MenuMsg,
								_user$project$Menu$view(model.menu)),
								A2(
								_elm_lang$html$Html_App$map,
								_user$project$MasterSe$PageLoaderMsg,
								_user$project$PageLoader$view(model.pageLoader))
							]))
					])),
...
var _user$project$App$main = {
	main: _elm_lang$html$Html_App$programWithFlags(
		{
			init: _user$project$MasterSe$initialModel,
			view: _user$project$MasterSe$view,
			update: _user$project$MasterSe$update,
