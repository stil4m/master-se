...
\paragraph{}
The contribution of this paper to the field of software engineering is tremendous. A lot of researchers used this paper
as basis for their research or simply as reference material. Mainly the cohesion metric has been research a lot (possibly
...
In present day there are no papers published with the form of 'A Metrics Suite for Object Oriented Design'. This has possibly
to do with the saturation on metric reseach and I expect that it is not possible to publish a whole new suite of metrics.
